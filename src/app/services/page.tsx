        ...
        <div className="pt-12 bg-white">
            ...
            <div className="container mx-auto px-6 md:px-12 mb-24">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {detailedServices.map((pkg, idx) => (
                        <div key={idx} className={`p-10 flex flex-col rounded-lg ${idx === 0 ? "bg-primary-50 border border-primary-200 relative shadow-sm" : "bg-zinc-50 border border-black/5"}`}>
                            {idx === 0 && (
                                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-primary-600 text-white text-xs uppercase tracking-widest py-1 px-4 rounded-full">
                                    Most Popular
                                </div>
                            )}
                            ...
                            <div className="text-3xl font-medium text-primary-700 mb-8">{pkg.price}</div>

                            <ul className="space-y-4 mb-10 flex-grow font-light text-sm">
                                {pkg.features.map((feature, fIdx) => (
                                    <li key={fIdx} className="flex items-start">
                                        <Check className="text-primary-500 mr-3 mt-0.5" size={16} shrink-0 />
            ...
            <div className="bg-primary-50 py-24">
                <div className="container mx-auto px-6 md:px-12 text-center max-w-3xl">
                    ...
                    <Link href="/contact" className="inline-flex items-center text-sm uppercase tracking-widest font-medium text-primary-700 hover:text-primary-900 border-b border-primary-300 hover:border-primary-700 pb-1">
