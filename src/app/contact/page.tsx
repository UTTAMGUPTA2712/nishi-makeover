            ...
            <div className="container mx-auto px-6 md:px-12 -mt-8 relative z-10 mb-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white p-8 shadow-sm border border-black/5 text-center flex flex-col items-center">
                        <div className="w-12 h-12 bg-primary-50 flex items-center justify-center rounded-full text-primary-600 mb-4">
                            <Mail size={20} />
                        </div>
                        <h3 className="font-serif text-xl mb-2">Email</h3>
                        <a href={`mailto:${siteData.contact.email}`} className="text-foreground/70 font-light hover:text-primary-600">{siteData.contact.email}</a>
                    </div>
                    ...
                    <div className="bg-white p-8 shadow-sm border border-black/5 text-center flex flex-col items-center">
                        ...
                        <a href={`tel:${siteData.contact.phone.replace(/[^0-9+]/g, '')}`} className="text-foreground/70 font-light hover:text-primary-600">{siteData.contact.phone}</a>
                    </div>
